...
export const House = ({ house }) => {
  const { image, type, country, address, bedrooms, bathrooms, surface, price } =
    house
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg rounded-tl-[5.63rem] w-full max-w-[22rem] mx-auto cursor-pointer hover:shadow-2xl transition'>
      ...
      <div className='text-lg font-semibold max-w-[16.25rem]'>{address}</div>
